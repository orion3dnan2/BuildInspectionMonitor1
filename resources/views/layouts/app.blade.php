        ...
        <aside class="w-72 bg-white dark:bg-slate-800 border-l border-slate-200 dark:border-slate-700 fixed h-full overflow-y-auto shadow-sm">
            ...
            <nav class="p-4 space-y-2">
                @if($isAdminSection)
                    ...
                    <div class="pt-2">
                        <p class="px-4 py-2 text-xs font-medium text-slate-400 uppercase">المرسلات والكتب</p>
                    </div>

                    <a href="{{ route('admin.correspondences.index') }}" class="sidebar-link flex items-center gap-4 px-4 py-3 rounded-lg text-slate-600 dark:text-slate-300 {{ request()->routeIs('admin.correspondences.index') || request()->routeIs('admin.correspondences.show') ? 'active' : '' }}">
                        <svg class="w-6 h-6 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                        </svg>
                        <span class="text-base">قائمة الكتب</span>
                    </a>

                    <a href="{{ route('admin.correspondences.create') }}" class="sidebar-link flex items-center gap-4 px-4 py-3 rounded-lg text-slate-600 dark:text-slate-300 {{ request()->routeIs('admin.correspondences.create') ? 'active' : '' }}">
                        <svg class="w-6 h-6 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                        </svg>
                        <span class="text-base">إضافة مراسلة</span>
                    </a>

                    <a href="{{ route('admin.correspondences.import') }}" class="sidebar-link flex items-center gap-4 px-4 py-3 rounded-lg text-slate-600 dark:text-slate-300 {{ request()->routeIs('admin.correspondences.import') ? 'active' : '' }}">
                        <svg class="w-6 h-6 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"></path>
                        </svg>
                        <span class="text-base">استيراد ملف</span>
                    </a>

                    <a href="{{ route('admin.correspondences.search-form') }}" class="sidebar-link flex items-center gap-4 px-4 py-3 rounded-lg text-slate-600 dark:text-slate-300 {{ request()->routeIs('admin.correspondences.search*') ? 'active' : '' }}">
                        <svg class="w-6 h-6 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                        </svg>
                        <span class="text-base">البحث في الكتب</span>
                    </a>
                ...
                <div class="pt-2">
                    <p class="px-4 py-2 text-xs font-medium text-slate-400 uppercase">إعدادات النظام</p>
                </div>
