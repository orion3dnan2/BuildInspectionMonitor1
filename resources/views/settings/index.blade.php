...
<div class="max-w-5xl mx-auto">
    ...
    <div class="bg-white rounded-xl border border-slate-200 mb-6">
        <div class="flex border-b border-slate-200">
            ...
            <a href="{{ route('settings.permissions.index') }}" class="flex-1 flex items-center justify-center gap-2 px-6 py-4 text-slate-500 hover:text-slate-700 hover:bg-slate-50 transition border-b-2 border-transparent text-sm">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
