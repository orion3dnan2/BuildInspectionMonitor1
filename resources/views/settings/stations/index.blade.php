            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-right font-medium text-gray-600">اسم المخفر</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-100" id="stationsTable">
                    ...
                    <tr class="hover:bg-gray-50 station-row" data-name="{{ strtolower($station->name) }}">
                        <td class="px-4 py-3">
                            <div class="flex items-center gap-2">
                                ...
                                <button onclick="editStation({{ $station->id }}, '{{ $station->name }}', '{{ $station->governorate }}')" class="bg-gray-100 text-gray-700 px-3 py-1.5 rounded-lg text-xs flex items-center gap-1 hover:bg-gray-200 transition">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <td class="px-4 py-3 text-gray-600">{{ $station->governorate ?? '-' }}</td>
    ...
    <div class="bg-white rounded-xl p-6 w-full max-w-md mx-4">
        ...
        <form id="station-form" method="POST">
            ...
            <div class="mb-4">
                ...
                <select name="governorate" id="station-governorate" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white">
