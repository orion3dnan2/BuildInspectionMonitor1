...
<div id="content-admin" class="tab-content hidden">
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        <div class="block bg-white rounded-xl p-8 text-center border border-slate-200 opacity-50">
            ...
            <h3 class="text-xl font-bold text-slate-600 mb-2">إدارة الموارد البشرية</h3>
            <p class="text-slate-400">قريباً...</p>
        </div>
    </div>
</div>
