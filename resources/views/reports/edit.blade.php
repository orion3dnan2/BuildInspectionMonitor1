...
@section('title', 'تعديل تقرير - نظام التفتيش والمراقبة')

@section('content')
<div class="mb-6">
    <h1 class="text-3xl font-bold text-gray-800">تعديل التقرير</h1>
    <p class="text-gray-600 mt-1">تعديل بيانات تقرير التفتيش</p>
</div>
    ...
    <form action="{{ route('reports.update', $report) }}" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="record_number" id="record_number" value="{{ old('record_number', $report->record_number) }}" required
            ...
            <div>
                ...
                <input type="text" name="outgoing_number" id="outgoing_number" value="{{ old('outgoing_number', $report->outgoing_number) }}"
            ...
            <div>
                ...
                <input type="text" name="officer_name" id="officer_name" value="{{ old('officer_name', $report->officer_name) }}" required
            ...
            <div>
                ...
                <input type="text" name="rank" id="rank" value="{{ old('rank', $report->rank) }}"
            ...
            <div>
                ...
                <input type="text" name="office_name" id="office_name" value="{{ old('office_name', $report->office_name) }}" required
            ...
            <div>
                ...
                <input type="date" name="inspection_date" id="inspection_date" value="{{ old('inspection_date', $report->inspection_date->format('Y-m-d')) }}" required
        ...
        <div>
            ...
            <textarea name="notes" id="notes" rows="4"
                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('notes') border-red-500 @enderror">{{ old('notes', $report->notes) }}</textarea>
            @error('notes')
            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
            @enderror
        </div>
